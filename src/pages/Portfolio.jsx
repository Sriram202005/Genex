...
function PortfolioSection() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 text-gray-900 py-12 px-6 md:px-20 mt-24">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-8 mb-10">
        <div className="flex-1">
          ...
          <p className="text-lg mb-6 leading-relaxed">
            We aim to develop trusting and valued relationships with you. Our methods aren’t focused on us — they are focused on <em>you</em>. 
